        ...
        <div className="bg-white dark:bg-[#0d0d0d] p-8 rounded-[2.5rem] border border-gray-100 dark:border-gray-800 shadow-sm mb-8">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 items-end">
                <div className="space-y-2">
                    <label className="text-xs font-black uppercase tracking-widest text-gray-400 ml-1">Industry</label>
                ...
                <div className="space-y-2">
                    <label className="text-xs font-black uppercase tracking-widest text-gray-400 ml-1">Radius (Miles)</label>
                    <div className="flex gap-2">
                        {radiuses.map(r => (
                            <button
                                ...
                                className={`flex-1 py-3 rounded-xl text-xs font-black uppercase border transition-all ${filters.radius === r ? 'bg-black dark:bg-white text-white dark:text-black border-black dark:border-white' : 'border-gray-100 dark:border-gray-800 text-gray-400'}`}
                            >
                                {r}
                            </button>
                        ))}
