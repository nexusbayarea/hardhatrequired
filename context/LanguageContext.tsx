...
const esDictionary: Record<string, string> = {
  ...
  'Intelligence Feed': 'Feed de Inteligencia',
  'BID': 'LICITACIÓN',
  'COMPLIANCE': 'CUMPLIMIENTO',
  'INDUSTRY NEWS': 'NOTICIAS INDUSTRIALES',
  'ALERT': 'ALERTA',
  'PERMIT': 'PERMISO',
  'MARKET SHIFT': 'CAMBIO DE MERCADO',
  'TODAY': 'HOY',
  'new bids': 'nuevas licitaciones',
  'compliance updates': 'actualizaciones de cumplimiento',
  'industry updates': 'actualizaciones de la industria',
  "Today's AI Briefing": 'Resumen de IA de Hoy',
  'All': 'Todo',
  'High Opportunity': 'Alta Oportunidad',
  'Moderate Opportunity': 'Oportunidad Moderada',
  'Low ROI': 'Bajo ROI',
  'High Value': 'Alto Valor',
  'Open RFP': 'RFP Abierta',
  'Medium RFP': 'RFP Media',
  'Complex RFP': 'RFP Compleja',
  'Generate Proposal →': 'Generar Propuesta →',
  'Action Required': 'Acción Requerida',
  'Explain →': 'Explicar →',
  'View Details →': 'Ver Detalles →',
  'AI Proposal Draft': 'Borrador de Propuesta de IA',
  'Copy Draft': 'Copiar Borrador',
  'Copied': 'Copiado',
  'Refresh': 'Actualizar',
  'Updated': 'Actualizado',
  'm ago': 'm atrás',
  'Scanning regional public bids & compliance updates...': 'Escaneando licitaciones públicas regionales y actualizaciones de cumplimiento...',
  'Generating...': 'Generando...',
  'Because you searched': 'Porque buscaste',
  'contractors': 'contratistas',
  'regulations': 'regulaciones',
  'facilities': 'instalaciones',
  'N/A': 'N/D',
  'Impacts': 'Impacta',
  'Avg penalty': 'Penalización promedio',
  'Est.': 'Est.',
  'compliance work': 'trabajo de cumplimiento',
  'LIVE': 'EN VIVO',
  ...
  'Ontology': 'Ontología',
  'Scoring': 'Puntuación',
  'search complete': 'búsqueda completa',
  'searching in progress...': 'búsqueda en progreso...',
  'Searching...': 'Buscando...',
  'Done': 'Hecho',
  '12 vendors discovered': '12 proveedores descubiertos',
  'within 50 mi radius': 'dentro de 50 millas de radio',
  'Featured Opportunity': 'Oportunidad Destacada',
  'Closing Soon': 'Cierra Pronto',
  'Open': 'Abierto',
  'AI Pitch Bid': 'Propuesta de IA',
  'Generate proposal in seconds': 'Genera una propuesta en segundos',
  'Value undisclosed': 'Valor no divulgado',
  'View all': 'Ver todas',
  'Companies Indexed': 'Empresas Indexadas',
  'Active Permits': 'Permisos Activos',
  'Equipment Assets': 'Equipos Disponibles',
  'Disposal Facilities': 'Instalaciones de Eliminación',
  'Deep Profiles': 'Perfiles Avanzados',
  'live platform coverage': 'cobertura de plataforma en vivo',
  'your market,': 'tu mercado,',
  'fully mapped.': 'completamente mapeado.',
  'equipment availability': 'disponibilidad de equipos',
  'nearby equipment.': 'equipos cercanos.',
  'ready to roll.': 'listos para rodar.',
  'Available near you': 'Disponible cerca de ti',
  'assets found': 'activos encontrados',
  'View full equipment catalog': 'Ver catálogo completo de equipos',
  'live logistics estimator': 'estimador de logística en vivo',
  'know your costs': 'conoce tus costos',
  'before you quote.': 'antes de cotizar.',
  'How much will it cost to haul?': '¿Cuánto costará transportar?',
  'total estimate': 'estimado total',
  'trips': 'viajes',
  'GAL capacity': 'capacidad GAL',
  'transit': 'tránsito',
  'total miles': 'millas totales',
  'hauling': 'transporte',
  'labor + truck': 'mano de obra + camión',
  'GAL': 'GAL',
  'disposal': 'eliminación',
  'operation hours': 'horas de operación',
  ...
  'Find Disposal': 'Buscar Eliminación',
  'Find Labor': 'Buscar Mano de Obra',
  'Rent Equipment': 'Alquilar Equipo',
  'What do you need today?': '¿Qué necesitas hoy?',
  'permitted facilities, tipping sites': 'instalaciones autorizadas, sitios de descarga',
...
const zhDictionary: Record<string, string> = {
  ...
  'Find Labor': '查找劳动力',
  'Rent Equipment': '租赁设备',
  'What do you need today?': '你今天需要什么？',
  'permitted facilities, tipping sites': '许可设施，倾倒场',
...
const viDictionary: Record<string, string> = {
  ...
  'Intelligence Feed': 'Nguồn cấp dữ liệu thông tin',
  ...
  'growth plan': 'Kế hoạch tăng trưởng',
  'plan': 'Kế hoạch',
  'credits': 'Tín dụng',
  'used': 'đã sử dụng',
  'new': 'Mới',
  ...
  'Find Disposal': 'Tìm Xử Lý',
  'Find Labor': 'Tìm Nhân Công',
  'Rent Equipment': 'Thuê Thiết Bị',
  'What do you need today?': 'Bạn cần gì hôm nay?',
  'permitted facilities, tipping sites': 'cơ sở được cấp phép, bãi đổ',
