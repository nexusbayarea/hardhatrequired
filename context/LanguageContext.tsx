...
const esDictionary: Record<string, string> = {
  ...
  'all types': 'Todos los tipos',
  'vacuum truck 3k': 'Camión de Vacío 3K',
  'vacuum truck 5k': 'Camión de Vacío 5K',
  'excavator (heavy)': 'Excavadora (Pesada)',
  'end dump trailer': 'Remolque de Volco Trasero',
  'frac tank 21k': 'Tanque de Fractura 21K',
  'dewatering pump': 'Bomba de Desagüe',
  'search radius': 'Radio de Búsqueda',
  ...
  'try expanding the search radius or changing the equipment class.': 'Intente ampliar el radio de búsqueda o cambiar la clase de equipo.',
  'provider': 'Proveedor',
  'class': 'Clase',
  'weekly': 'Semanal',
  ...
  'verified': 'Verificado',
  'book': 'Reservar',
  'reserve gear': 'Reservar Equipo',
  'per day': 'por día',
  'weekly estimate': 'Estimado Semanal',
  'proximity': 'Proximidad',
  'inquiry sent': 'Consulta Enviada',
  'the provider has been notified of your interest.': 'El proveedor ha sido notificado de su interés.',
  'done': 'Hecho',
  'daily rate': 'Tarifa Diaria',
  'delivery fee': 'Cargo de Entrega',
  'lease start': 'Inicio de Arrendamiento',
  'lease end (optional)': 'Fin de Arrendamiento (opcional)',
  'notes (optional)': 'Notas (opcional)',
  'special requirements or delivery instructions...': 'Requisitos especiales o instrucciones de entrega...',
  'sending inquiry...': 'Enviando consulta...',
  'call provider': 'Llamar al Proveedor',
  'dispatch email': 'Correo de Despacho',
  'conf.': 'Conf.',
  'go': 'Ir',
  'daily': 'Diario',
};
...
const zhDictionary: Record<string, string> = {
  ...
  'all types': '所有类型',
  'vacuum truck 3k': '3K真空卡车',
  'vacuum truck 5k': '5K真空卡车',
  'excavator (heavy)': '挖掘机（重型）',
  'end dump trailer': '后卸式拖车',
  'frac tank 21k': '21K压裂罐',
  'dewatering pump': '脱水泵',
  'search radius': '搜索半径',
  'target date': '目标日期',
  'composite': '综合',
  ...
  'try expanding the search radius or changing the equipment class.': '尝试扩大搜索半径或更改设备类别。',
  'provider': '供应商',
  'class': '类别',
  'weekly': '每周',
  'total budget': '总预算',
  ...
  'reserve gear': '预订设备',
  'per day': '每天',
  'weekly estimate': '每周估算',
  'proximity': '邻近度',
  'inquiry sent': '询价已发送',
  'the provider has been notified of your interest.': '供应商已收到您的询价通知。',
  'done': '完成',
  'daily rate': '每日费率',
  'delivery fee': '配送费',
  'lease start': '租赁开始',
  'lease end (optional)': '租赁结束（可选）',
  'notes (optional)': '备注（可选）',
  'special requirements or delivery instructions...': '特殊要求或配送说明...',
  'sending inquiry...': '正在发送询价...',
  'call provider': '致电供应商',
  'dispatch email': '发送邮件',
  'conf.': '置信',
  'go': '前往',
...
const viDictionary: Record<string, string> = {
  ...
  'all types': 'Tất cả loại',
  'vacuum truck 3k': 'Xe tải chân không 3K',
  'vacuum truck 5k': 'Xe tải chân không 5K',
  'excavator (heavy)': 'Máy xúc (Hạng nặng)',
  'end dump trailer': 'Rơ moóc đổ sau',
  'frac tank 21k': 'Bể chứa frac 21K',
  'dewatering pump': 'Máy bơm khử nước',
  'search radius': 'Bán kính tìm kiếm',
  'target date': 'Ngày mục tiêu',
  'composite': 'Tổng hợp',
  'daily_rate': 'Giá hàng ngày',
  'cards': 'Thẻ',
  'table': 'Bảng',
  'no equipment found': 'Không tìm thấy thiết bị',
  'try expanding the search radius or changing the equipment class.': 'Hãy thử mở rộng bán kính tìm kiếm hoặc thay đổi loại thiết bị.',
  ...
  'book': 'Đặt',
  'reserve gear': 'Đặt thiết bị',
  'per day': 'mỗi ngày',
  'weekly estimate': 'Ước tính hàng tuần',
  'proximity': 'Khoảng cách',
  'inquiry sent': 'Đã gửi yêu cầu',
  'the provider has been notified of your interest.': 'Nhà cung cấp đã được thông báo về sự quan tâm của bạn.',
  'done': 'Xong',
  'daily rate': 'Giá hàng ngày',
  'delivery fee': 'Phí giao hàng',
  'lease start': 'Bắt đầu thuê',
  'lease end (optional)': 'Kết thúc thuê (tùy chọn)',
  'notes (optional)': 'Ghi chú (tùy chọn)',
  'special requirements or delivery instructions...': 'Yêu cầu đặc biệt hoặc hướng dẫn giao hàng...',
  'sending inquiry...': 'Đang gửi yêu cầu...',
  'call provider': 'Gọi cho nhà cung cấp',
  'dispatch email': 'Email điều phối',
  'conf.': 'T.cậy',
  'go': 'Đi',
  'daily': 'Hàng ngày',
};
